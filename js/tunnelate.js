        ...
        switch(activetab) {
          ...
          case "soican-web":
            ...
            if (proxymode != "remote-proxy-create")
              ...
              '<code style="background: black; padding: 1em; display: block;>">curl --socks5 localhost:' + tunnelport + " google.com</code>";
          ...
          case "soican-hop":
            ...
            $("#using-step").hide();
            break;
          //# next use case:  ssh -tA nectar-tunnelator -R 10022:localhost:22
        }
...
1)
browser 18080 ===> [ 8080:internal server ]

2) 
smtp 10025 ===> [ --]-> 25:mail.google
pop 10110 ===> [ --]-> 110:mail.google

3a)
proxy 11080 ===> [ 1080:myproxy ]
3b)
proxy 11080 ===> [ --]->  1080:proxy.company
3c)
proxy 11080 ===> [ 1080:sshproxy ]

4)
sshproxy:1080 <=== [ 11080:curl ]
